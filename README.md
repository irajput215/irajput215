<div align="center">
  ...
  <a href="https://github.com/irajput215">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&duration=2600&pause=1000&color=38BDF8&center=true&vCenter=true&width=680&lines=Hi%2C%20I%27m%20Ishu%20Rajput;Software%20Engineer;Data%20Engineer;AI%20Engineer;Building%20Systems%20That%20Hold%20Up%20in%20Production" alt="Typing SVG Banner" />
  </a>

  <p align="center">
    <strong>Software Engineering &bull; Data Engineering &bull; AI Engineering</strong>
  </p>
  ...
  <p align="center">
    ...
    <img src="https://img.shields.io/badge/Focus-Software%20%2B%20Data%20%2B%20AI-8B5CF6?style=flat-square" alt="Focus" />
  </p>
...
<p align="center">
  <img src="https://img.shields.io/badge/SOFTWARE%20ENGINEERING-0EA5E9?style=for-the-badge" alt="Software Engineering" />
  <img src="https://img.shields.io/badge/DATA%20ENGINEERING-8B5CF6?style=for-the-badge" alt="Data Engineering" />
  <img src="https://img.shields.io/badge/AI%20ENGINEERING-F59E0B?style=for-the-badge" alt="AI Engineering" />
</p>
...
- **Production Reliability &amp; Incident Response:** MLflow experiment tracking, drift and data-quality monitoring, structured tracing, human-in-the-loop approval gates on anything that mutates production data, and root-cause analysis that reports <code>UNRESOLVED</code> rather than guessing.
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p><strong>Full-Stack Agentic RAG Platform with Citations &amp; Evals</strong></p>
      <p>A complete application: FastAPI backend with a React 19 + TypeScript front end, built as a typed monorepo with Docker packaging and CI. Users upload course material, state a goal, and get answers grounded in those documents — with citations, a prerequisite-aware roadmap, quizzes and progress-adaptive planning. Hybrid retrieval over PostgreSQL + pgvector, a knowledge graph, a bounded LangGraph, and a measured evaluation pipeline, held up by <strong>1,643 tests at 83% coverage</strong> under strict <code>mypy</code> and <code>ruff</code>.</p>
      <p>
        ...
        <img src="https://img.shields.io/badge/mypy%20strict-2A6DB2?style=flat-square" alt="mypy" />
      </p>
      <p>
...
<div align="center">
  <p>
    <strong>Open to software, data and AI engineering roles, and to collaborating on production systems that need to be reliable, observable and well-architected.</strong>
  </p>
